...
- **MVP включает:**  
  * Классификация тональности (3 класса).  
  * REST-API (FastAPI + Docker).  
  * Мини-дашборд (Grafana).  
  * Интерфейс обратной связи для модераторов.

- **Технический долг:**  
  * Онлайн-дообучение.  
  * Мультимодальность (картинки, эмодзи).  
  * Автоматическая корректировка на основе фидбэка.  
  * Расширенный мониторинг чатов и комментариев.
